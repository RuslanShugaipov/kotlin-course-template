...
internal class CalculatorKtTest {
    ...
    @Test
    fun `checking the correctness of the conversion (input9)`() {
        Assert.assertEquals("5 u- sin u-", getRPN(input9))
    }

    @Test
    fun `checking the correctness of the conversion (input10)`() {
        Assert.assertEquals("5 u+ sin u+ u-", getRPN(input10))
    }
